...
import cc.thonly.blockuspatch.block.base.mod.BarrierImpl;
import cc.thonly.blockuspatch.block.base.mod.PostImpl;
import cc.thonly.blockuspatch.block.base.TransparentPillarImpl;
import cc.thonly.blockuspatch.block.base.mod.SmallHedgeImpl;
...
public class BlockEntry {
    ...
    public PolymerBlock requestPolymerBlock(Block base, Block block) {
        ...
        if (block instanceof CarpetBlock carpetBlock) {
            polymerBlock = new CarpetImpl(id);
        }
